...
// Here's the deal: the platforms of current interest are either x86
// little endian, or Mac OS X PPC, and in the latter case __BIG_ENDIAN__ is
// handily already #defined. If you compiled this on a Sparc-based Sun machine,
// you had better make sure to #define __BIG_ENDIAN__, however.
